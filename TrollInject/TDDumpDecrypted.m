...
-(id) initWithPathToBinary:(NSString *)path
...
-(NSString *)IPAPath {
    return [NSString stringWithFormat:@"%@/%@_%@_%@.ipa", 
            [self docPath], self.appName, self.appVersion,
            self.crypted ? @"crypted" : @"decrypted"];
}
